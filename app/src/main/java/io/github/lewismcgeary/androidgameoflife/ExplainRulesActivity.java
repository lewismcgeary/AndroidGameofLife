...
public class ExplainRulesActivity extends AppIntro2 {
    ...
    public void init(@Nullable Bundle savedInstanceState) {
        CustomAppIntroFragment summaryFragment = CustomAppIntroFragment.newInstance("Game of Life", "In the Game of Life, the world is a grid of cells that are dead or alive. \n \nThis is a zero-player game.\n \nYou decide which cells are alive at the start of the game, but when play starts, the world evolves on its own following some simple rules...", R.mipmap.life_logo_launcher, ContextCompat.getColor(getApplicationContext(), android.R.color.holo_orange_light));
        ...
        addSlide(AppIntroFragment.newInstance("Overcrowding", "A cell with more than three live neighbours will die", R.drawable.rules_greater_than_three, ContextCompat.getColor(getApplicationContext(), android.R.color.holo_orange_light)));
        addSlide(AppIntroFragment.newInstance("Conception", "A dead cell with exactly three live neighbours will come to life", R.drawable.rules_exactly_three, ContextCompat.getColor(getApplicationContext(), android.R.color.holo_orange_light)));
